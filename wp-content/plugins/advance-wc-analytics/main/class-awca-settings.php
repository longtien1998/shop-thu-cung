...
class AWCA_Settings {
	...
	public function __construct(){
		...
		if(class_exists('WooCommerce')){
			...
			$this->awca_dash_stats_data_dash = array(
				'transactionRevenue'=>array('payments','Total Revenue','money',true, true),
				'transactions'=>array('receipt_long','Total Transctions','',false, true),
				'transactionsPerSession'=>array('alarm_on','Conversion Rate','%',false, true),
				'users'=>array('people_alt','Users','',true, true),
				'avgSessionDuration'=>array('timer','Avg Session Duration','s',false,true),
				'bounceRate'=>array('timeline','Bounce Rate','%',false, false),
				'revenuePerTransaction'=>array('receipt','Avg Transction Revenue','money',true,true),
				'avgPageLoadTime'=>array('restart_alt','Avg Pageload Time','s',false,false),
			);
			/* WooCommerce Dashboard */
